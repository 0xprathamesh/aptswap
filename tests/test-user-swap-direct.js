...
const SEPOLIA_RPC_URL =
  "https://sepolia.infura.io/v3/c200bd60e6934222a9e878361cc39740";
...
async function testUserCrossChainSwap() {
  ...
  try {
    ...
    console.log(`1. Sepolia Escrow Creation: ${sepoliaReceipt.hash}`);
    console.log(`2. Aptos Swap Ledger Init: ${ledgerHash}`);
    console.log(
      `3. Aptos Order Announcement: ${announceResult.hash} (Order ID: ${announceOrderId})`
    );
    console.log(
      `4. Aptos Escrow Funding: ${fundResult.hash} (Order ID: ${fundOrderId})`
    );
    console.log(
      `5. Aptos Funds Claimed: ${claimHash} (Order ID: ${fundOrderId})`
    );
    console.log("");
